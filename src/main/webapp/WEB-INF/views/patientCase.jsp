    ...
    <div class="content">
        ...
        <form:form action="/T_school_war_exploded/cases/${patientId}/update/${caseId}" method="POST"
            ...
            <div class="form-group-create row">
                ...
                <form:input cssClass="form-s form-notactiv" disabled="true" path="patient.secondName"/>
            </div>
            <div class="form-group-create row">
            ...
            <div class="form-group-create row">
                ...
                <form:input cssClass="form-s form-notactiv" disabled="true" readonly="true" type="data"
                            path="startDate"/>
            </div>
            <div class="form-group-create row">
                <b class="col-xs-3">Окончание</b>
                <form:input cssClass="form-s form-notactiv" disabled="true" readonly="true" type="data" path="endDate"/>
            </div>
